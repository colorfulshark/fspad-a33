 ...
 */
/* 不配置速度类型 */
static void __USBC_Host_TsMode_Default(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_b(USBC_BP_POWER_H_HIGH_SPEED_EN, USBC_REG_PCTL(usbc_base_addr));
}

/* 配置 high speed */
static void __USBC_Host_TsMode_Hs(ulong usbc_base_addr)
{
    USBC_REG_set_bit_b(USBC_BP_POWER_H_HIGH_SPEED_EN, USBC_REG_PCTL(usbc_base_addr));
}

/* 配置 full speed */
static void __USBC_Host_TsMode_Fs(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_b(USBC_BP_POWER_H_HIGH_SPEED_EN, USBC_REG_PCTL(usbc_base_addr));
}

/* 配置 low speed */
static void __USBC_Host_TsMode_Ls(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_b(USBC_BP_POWER_H_HIGH_SPEED_EN, USBC_REG_PCTL(usbc_base_addr));
}

static void __USBC_Host_ep0_EnablePing(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_CSR0_H_DisPing, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_DisablePing(ulong usbc_base_addr)
{
    USBC_REG_set_bit_w(USBC_BP_CSR0_H_DisPing, USBC_REG_CSR0(usbc_base_addr));
}

static __u32 __USBC_Host_ep0_IsNakTimeOut(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_CSR0_H_NAK_Timeout, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_ClearNakTimeOut(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_CSR0_H_NAK_Timeout, USBC_REG_CSR0(usbc_base_addr));
}

static __u32 __USBC_Host_ep0_IsError(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_CSR0_H_Error, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_ClearError(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_CSR0_H_Error, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_EpType(ulong usbc_base_addr, __u32 ts_mode)
{
    __u32 reg_val = 0;
...
static void __USBC_Host_ep0_FlushFifo(ulong usbc_base_addr)
{
    USBC_Writew(1 << USBC_BP_CSR0_H_FlushFIFO, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_ConfigEp_Default(ulong usbc_base_addr)
{
    //--<1>--config ep0 csr
    USBC_Writew(1<<USBC_BP_CSR0_H_FlushFIFO, USBC_REG_CSR0(usbc_base_addr));
...
static void __USBC_Host_ep0_ConfigEp(ulong usbc_base_addr, __u32 ts_mode, __u32 interval)
{
    //--<1>--config ep0 csr
    USBC_Writew(1<<USBC_BP_CSR0_H_FlushFIFO, USBC_REG_CSR0(usbc_base_addr));
...
static __u32 __USBC_Host_ep0_IsReadDataReady(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_CSR0_H_RxPkRdy, USBC_REG_CSR0(usbc_base_addr));
}

static __u32 __USBC_Host_ep0_IsWriteDataReady(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_CSR0_H_TxPkRdy, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_ReadDataHalf(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_CSR0_H_RxPkRdy, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_ReadDataComplete(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_CSR0_H_RxPkRdy, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_WriteDataHalf(ulong usbc_base_addr)
{
	USBC_REG_set_bit_w(USBC_BP_CSR0_H_TxPkRdy, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_WriteDataComplete(ulong usbc_base_addr)
{
	USBC_REG_set_bit_w(USBC_BP_CSR0_H_TxPkRdy, USBC_REG_CSR0(usbc_base_addr));
}

static __u32 __USBC_Host_ep0_IsStall(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_CSR0_H_RxStall, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_ClearStall(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_CSR0_H_RxStall, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_ClearCSR(ulong usbc_base_addr)
{
    USBC_Writew(0x00, USBC_REG_CSR0(usbc_base_addr));
}

static __u32 __USBC_Host_ep0_IsReqPktSet(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_CSR0_H_ReqPkt, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_StartInToken(ulong usbc_base_addr)
{
	USBC_REG_set_bit_w(USBC_BP_CSR0_H_ReqPkt, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_StopInToken(ulong usbc_base_addr)
{
	USBC_REG_clear_bit_w(USBC_BP_CSR0_H_ReqPkt, USBC_REG_CSR0(usbc_base_addr));
}

static void __USBC_Host_ep0_StatusAfterIn(ulong usbc_base_addr)
{
    __u32 reg_val = 0;
...
static void __USBC_Host_ep0_StatusAfterOut(ulong usbc_base_addr)
{
    __u32 reg_val = 0;
...
static void __USBC_Host_ep0_SendSetupPkt(ulong usbc_base_addr)
{
    __u32 reg_val = 0;
...
static void __USBC_Host_Tx_EpType(ulong usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type)
{
    __u32 reg_val = 0;
...
static void __USBC_Host_Tx_FlushFifo(ulong usbc_base_addr)
{
    USBC_Writew((1 << USBC_BP_TXCSR_H_CLEAR_DATA_TOGGLE) | (1 << USBC_BP_TXCSR_H_FLUSH_FIFO),
                USBC_REG_TXCSR(usbc_base_addr));
}

static void __USBC_Host_Tx_ConfigEp_Default(ulong usbc_base_addr)
{
...
static void __USBC_Host_Tx_ConfigEp(ulong usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type, __u32 is_double_fifo, __u32 ep_MaxPkt, __u32 interval)
{
    __u16 reg_val = 0;
	__u16 temp = 0;
...
static void __USBC_Host_Tx_ConfigEpDma(ulong usbc_base_addr)
{
    __u16 ep_csr = 0;
...
static void __USBC_Host_Tx_ClearEpDma(ulong usbc_base_addr)
{
    __u16 ep_csr = 0;
...
static __u32 __USBC_Host_Tx_IsWriteDataReady(ulong usbc_base_addr)
{
...
static void __USBC_Host_Tx_WriteDataHalf(ulong usbc_base_addr)
{
    USBC_REG_set_bit_w(USBC_BP_TXCSR_H_TX_READY, USBC_REG_TXCSR(usbc_base_addr));
}

static void __USBC_Host_Tx_WriteDataComplete(ulong usbc_base_addr)
{
    USBC_REG_set_bit_w(USBC_BP_TXCSR_H_TX_READY, USBC_REG_TXCSR(usbc_base_addr));
}

static __u32 __USBC_Host_Tx_IsNakTimeOut(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_TXCSR_H_NAK_TIMEOUT, USBC_REG_TXCSR(usbc_base_addr));
}

static void __USBC_Host_Tx_ClearNakTimeOut(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_TXCSR_H_NAK_TIMEOUT, USBC_REG_TXCSR(usbc_base_addr));
}

static __u32 __USBC_Host_Tx_IsError(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_TXCSR_H_ERROR, USBC_REG_TXCSR(usbc_base_addr));
}

static void __USBC_Host_Tx_ClearError(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_TXCSR_H_ERROR, USBC_REG_TXCSR(usbc_base_addr));
}

static __u32 __USBC_Host_Tx_IsStall(ulong usbc_base_addr)
{
    return USBC_REG_test_bit_w(USBC_BP_TXCSR_H_TX_STALL, USBC_REG_TXCSR(usbc_base_addr));
}

static void __USBC_Host_Tx_ClearStall(ulong usbc_base_addr)
{
    USBC_REG_clear_bit_w(USBC_BP_TXCSR_H_TX_STALL, USBC_REG_TXCSR(usbc_base_addr));
}

/*
static void __USBC_Host_Tx_ForbidStall(ulong usbc_base_addr)
{
    USBC_REG_set_bit_w(USBC_BP_TXCSR_H_RX_STALL, USBC_REG_TXCSR(usbc_base_addr));
}
*/

static void __USBC_Host_Tx_ClearCSR(ulong usbc_base_addr)
{
    USBC_Writew(0x00, USBC_REG_TXCSR(usbc_base_addr));
}

static void __USBC_Host_Rx_EpType(ulong usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type)
{
    __u32 reg_val = 0;
...
static void __USBC_Host_Rx_FlushFifo(ulong usbc_base_addr)
{
    USBC_Writew((1 << USBC_BP_RXCSR_H_CLEAR_DATA_TOGGLE) | (1 << USBC_BP_RXCSR_H_FLUSH_FIFO),
                USBC_REG_RXCSR(usbc_base_addr));
}

static void __USBC_Host_Rx_ConfigEp_Default(ulong usbc_base_addr)
{
...
static void __USBC_Host_Rx_ConfigEp(ulong usbc_base_addr, __u32 ep_index, __u32 ts_mode, __u32 ts_type, __u32 is_double_fifo, __u32 ep_MaxPkt, __u32 interval)
{
    __u16 reg_val = 0;
	__u16 temp = 0;
...
static void __USBC_Host_Rx_ConfigEpDma(ulong usbc_base_addr)
{
    __u16 ep_csr = 0;
...
static void __USBC_Host_Rx_ClearEpDma(ulong usbc_base_addr)
{
    __u16 ep_csr = 0;
...
static __s32 __USBC_Host_ReadDataHalf(ulong usbc_base_addr, __u32 ep_type)
{
	switch(ep_type){
		case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Host_ReadDataComplete(ulong usbc_base_addr, __u32 ep_type)
{
	switch(ep_type){
		case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Host_WriteDataHalf(ulong usbc_base_addr, __u32 ep_type)
{
	switch(ep_type){
		case USBC_EP_TYPE_EP0:
...
static __s32 __USBC_Host_WriteDataComplete(ulong usbc_base_addr, __u32 ep_type)
{
	switch(ep_type){
		case USBC_EP_TYPE_EP0:
